...
class userEmergencyContactsPage extends StatefulWidget {
  final String patientId;
  final String patientName;

  const userEmergencyContactsPage({
    super.key,
  ...
  @override
  State<userEmergencyContactsPage> createState() => _userEmergencyContactsPageState();
}

class _userEmergencyContactsPageState extends State<userEmergencyContactsPage> {
