...
class _DoctorAppointmentPageState extends State<DoctorAppointmentPage> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Response Section
              if (appointment['response'] != null)
                Container(
                  margin: const EdgeInsets.only(top: 8),
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
                    color: appointment['response'] == 'Visited'
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (appointment['response_time'] != null)
                        Padding(
                          padding: const EdgeInsets.only(top: 4),
                          child: Text(
                            'Responded on: ${_formatDateTime(appointment['response_time'])}',
                            style: TextStyle(
  ...
  Color _getResponseColor(String? response) {
    if (response == null) return Colors.grey;
    return response == 'Visited' ? Colors.green : Colors.orange;
  }

  String _getResponseText(String? response) {
    if (response == null) return 'No Response';
    return response == 'Visited' ? 'Will Attend' : 'Will Not Attend';
  }

  IconData _getResponseIcon(String? response) {
    if (response == null) return Icons.help_outline;
    return response == 'Visited' ? Icons.check_circle : Icons.cancel;
  }
  ...
  Widget _buildAppointmentCard(Map<String, dynamic> appointment) {
    ...
    // Response data
    final hasResponse = appointment['response'] != null;
    final responseColor = _getResponseColor(appointment['response']);
    final responseText = _getResponseText(appointment['response']);
    final responseIcon = _getResponseIcon(appointment['response']);
