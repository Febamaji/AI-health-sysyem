...
class userAddMedicinePage extends StatefulWidget {
  final String pid;
  const userAddMedicinePage({super.key, required this.pid});

  @override
  State<userAddMedicinePage> createState() => _userAddMedicinePageState();
}

class _userAddMedicinePageState extends State<userAddMedicinePage> {
  ...
  void _navigateToViewMedicine() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => userViewMedicinePage(paid: widget.pid)),
    );
  }
...
class userViewMedicinePage extends StatefulWidget {
  final String paid;
  const userViewMedicinePage({super.key, required this.paid});

  @override
  State<userViewMedicinePage> createState() => _userViewMedicinePageState();
}

class _userViewMedicinePageState extends State<userViewMedicinePage> {
